...
from routes import student_router, analytics_router, predictions_router, auth_router
...
app = FastAPI(
    ...
    description="REST API for Learnova student performance prediction and risk intelligence",
    version="1.0.0"
)
...
@app.get("/api/health")
def health():
    return {"status": "healthy", "service": "Learnova Backend"}
